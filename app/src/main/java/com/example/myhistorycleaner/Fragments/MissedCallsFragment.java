 ...
 */
public class MissedCallsFragment extends Fragment implements CallAdapter.Clickable
{
    View view;
    CallAdapter.Clickable clickable;

    //Declaration of variables to keep counts of missed call type
    ...
    //Array list containing object of missed calls
    ArrayList<Calls> missedCallArrayList = new ArrayList<>();
    ...
    public static MissedCallsFragment newInstance(int page) {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        missedCallArrayList.clear();
        getMissedCallDetails();

        layoutManager = new LinearLayoutManager(getActivity().getApplicationContext());
        rvAllCalls.setLayoutManager(layoutManager);

        callAdapter = new CallAdapter(missedCallArrayList,getActivity(),this,cr);
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) throws SecurityException
            {
                ...
                alertDialogBuilder.setMessage("Do you want to Delete Missed Call History?");
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) throws SecurityException {
                        ...
                        {
                            int countMsg = 0;
                            for (int i = 0; i < missedCallArrayList.size(); i++)
                            {
                                Calls mCalls = missedCallArrayList.get(i);
                            ...
                            Toast.makeText(getActivity(),countMsg + " missed calls deleted",
        ...
        btnSelectAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(btnSelectAll.getText().equals("Select All")) {
                    for (int i = 0; i < missedCallArrayList.size(); i++) {
                        missedCallArrayList.get(i).setSelected(true);
                        click(i, true);
                    }
                ...
                {
                    for (int i = 0; i < missedCallArrayList.size(); i++) {
                        missedCallArrayList.get(i).setSelected(false);
                        click(i, false);
                    }
    ...
    private void getMissedCallDetails() throws SecurityException
    {
        if(hasPermissions(getActivity(), call_permissions))
        {
            String strOrder = android.provider.CallLog.Calls.DATE + " DESC";
            Cursor managedCursor = getActivity().getContentResolver().query(CallLog.Calls.CONTENT_URI, null, "type = 3", null,strOrder);
            ...
            while (managedCursor.moveToNext()) {
                ...
                missedCallArrayList.add(new Calls(managedCursor.getString(id),managedCursor.getString(name),
        ...
        allCount = missedCallArrayList.size();
    }
    ...
    {
        missedCallArrayList.get(position).isSelected = flag;
    }
