 ...
 */
public class InboxFragment extends Fragment implements SmsAdapter.Clickable
{
    View view;
    ...
    ArrayList<SmsModel> inboxArrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        smsAdapter = new SmsAdapter(inboxArrayList,getActivity(),this,getActivity().getContentResolver());
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) throws SecurityException
            {
                ...
                alertDialogBuilder.setMessage("Do you want to Delete All Inbox SMS?");
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) throws SecurityException {
                        if (hasPermissions(getActivity(), sms_permissions))
                        {
                            ...
                            {
                                SmsModel msmsModel = inboxArrayList.get(i);
        ...
        btnSelectAll.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(btnSelectAll.getText().equals("Select All")) {
                    for (int i = 0; i < inboxArrayList.size(); i++) {
                        inboxArrayList.get(i).setSelected(true);
                        Smsclick(i, true);
                    }
                ...
                {
                    for (int i = 0; i < inboxArrayList.size(); i++) {
                        inboxArrayList.get(i).setSelected(false);
                        Smsclick(i, false);
                    }
    ...
    private void getInboxDetails()
    {
        if(hasPermissions(getActivity(),sms_permissions))
        {
            ...
            while (c.moveToNext())
            {
                ...
                if(dircode == Telephony.Sms.MESSAGE_TYPE_INBOX)
                {
                    dir = "Inbox";
                    inboxCount++;
                }
                ...
                inboxArrayList.add(new SmsModel(c.getString(id),c.getString(name),
                        c.getString(msg), dir,
                        smsDay + "", false));
            }
            c.close();
        }
        allSmsCount = inboxArrayList.size();
    }
    ...
    {
        inboxArrayList.get(position).isSelected = flag;
    }
